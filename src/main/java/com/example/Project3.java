...
public class Project3{
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true){
            ...
            // Load questions from classpath resource
            ArrayList<Question> list = loadQuestions();
    ...
    /**
     * Loads questions from classpath resource (src/main/resources/question.txt)
     */
    public static ArrayList<Question> loadQuestions() throws Exception {
        InputStream inStream = Project3.class.getClassLoader().getResourceAsStream("question.txt");
        if (inStream == null) {
            throw new FileNotFoundException("question.txt not found in classpath");
        }
